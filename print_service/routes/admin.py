...
@router.post("/update")
async def manual_update_terminal(input: UpdateInput, user=Depends(UnionAuth(scopes=["print.terminal.service"]))):
...
@router.post("/reboot")
async def reboot_terminal(input: RebootInput, user=Depends(UnionAuth(scopes=["print.terminal.service"]))):
